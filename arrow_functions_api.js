...
const getUsers = () => formatResponse(200, users, "List of users obtained.");
const getUsersResult = getUsers();
console.log("Get All Users:", getUsersResult);

// Function to get the number of users
const getUsersSize = () => formatResponse(200, users.length, "Number of users obtained.");
...
const getUserResult = getUser("erasmo_diaz");
