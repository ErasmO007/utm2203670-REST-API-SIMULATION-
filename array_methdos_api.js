...
//Function that make the search for tilte or isbn
...
addbook()
console.log("the nwe book is:")
const ultimoElemento = Books[Books.length - 1]
console.log(ultimoElemento)
console.log("the new array is:")
console.log(Books)

//Delete book for tilte or isbn and later show de new array
console.log("")
function deleteBook(search) {
    ...
    if (index !== -1) {
        ...
        console.log("no book was found with this title or isbn")
    }
}
...
console.log("ew array whit the book erased :")
console.log(Books)

//show books that are the same in the publisher,author or genre
console.log("")
function searchBooks(matching) {
...
console.log("the news books whit the publisher, author y genre is:")
...
const matchBooks = searchBooks(yearfilter)

console.log("the books that match are:")
matchBooks.forEach(book => console.log(book))

//check if a genre has stock
console.log("")
function stockAvailable(genre){
    const booksType=Books.filter(book=> book.genre===genre)
    return booksType.every(book=>book.stock>0)
}

const check="Fantasy"
const result=stockAvailable(check)
console.log("the genre; ", check , ",has stock available:" ,result,)

//check if at least one genre has one book
console.log("")
function oneAvailable(genre){
    return Books.some(book=>book.genre==genre && book.stock >0)
}
const cheeck="Fantasy"
const available= oneAvailable(cheeck)
console.log("the genre:",cheeck,",has at leastone book available :",available,)

//counting the property and show
console.log("")
function countbooks(property){
    const count={}
    Books.forEach(book=>{const value=book[property]
        if(!count[value]){
            count[value]=1
        }
        else{
